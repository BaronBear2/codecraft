...
class _LevelFiveScreenState extends State<LevelFiveScreen> with TickerProviderStateMixin {
  ...
  static const int goalBlockCount = 10;
          ...
          children: [
            ...
            Scaffold(
              ...
              appBar: AppBar(
                title: Row(
                  children: [
                    const Text("Level 5", style: TextStyle(fontFamily: 'Jua', color: Colors.black)),
              ...
              body: Column(
                children: [
                  const Padding(
                    ...
                    child: Text(
                      "Level 5: Tantangan Lebih Panjang!\nArahkan penguin ke ikan",
                      style: TextStyle(
                        fontFamily: 'Jua',
                        fontSize: 18,
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                Navigator.pushReplacementNamed(context, '/level6');
                              },
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                ...
                                "2. Klik tombol Move, Move Back, Move Down, Move Up, dan Loop!\n"
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            const Text(
                              "Gunakan 2 Move, 2 Move Back, 3 Move Up, dan 4 Loop!\nCoba gunakan Loop untuk menghemat blok.",

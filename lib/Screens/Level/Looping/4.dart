...
enum BlockType { move, moveBack, moveDown, moveUp, repeat }
...
class _LevelFourScreenState extends State<LevelFourScreen> with TickerProviderStateMixin {
  ...
  // Level 4's active tiles (same as Level 3)
  ...
  void runProgram() async {
    ...
    setState(() {
      isRunning = false;
      if (penguinRow == 0 && penguinCol == 5 && _countBlocks(program) <= goalBlockCount) {
        showSuccess = true;
      } else {
        showFail = true;
      }
          ...
          LongPressDraggable<List<int>>(
            ...
            child: DragTarget<List<int>>(
              ...
              builder: (context, candidateData, rejectedData) {
                if (block.type == BlockType.move || block.type == BlockType.moveBack || block.type == BlockType.moveDown || block.type == BlockType.moveUp) {
          ...
          children: [
            ...
            Scaffold(
              ...
              appBar: AppBar(
                title: Row(
                  children: [
                    const Text("Level 4", style: TextStyle(fontFamily: 'Jua', color: Colors.black)),
              ...
              body: Column(
                children: [
                  const Padding(
                    ...
                    child: Text(
                      "Level 4: Tantangan baru! Susun blok agar penguin bisa mencapai ikan.",
                      style: TextStyle(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                Navigator.pushReplacementNamed(context, '/level5');
                              },
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            const Text(
                              "Gunakan blok dengan efisien dan manfaatkan Loop untuk menyelesaikan tantangan!",

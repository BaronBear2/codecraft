...
class _SertifikatScreenState extends State<SertifikatScreen> with TickerProviderStateMixin {
  ...
  Future<void> _setSertifikatCompleted() async {
    final user = FirebaseAuth.instance.currentUser;
    if (user != null) {
      final doc = FirebaseFirestore.instance.collection('user_progress').doc(user.uid);
      await doc.set({'sertifikat': 1}, SetOptions(merge: true));
    }
  }
          ...
          children: [
            ...
            Scaffold(
              ...
              appBar: AppBar(
                title: Row(
                  children: [
                    const Text("Sertifikat", style: TextStyle(fontFamily: 'Jua', color: Colors.black)),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                await _setSertifikatCompleted();
                                Navigator.pushReplacementNamed(context, '/sertif_download');
                              },
                              child: const Text("Selesai", style: TextStyle(fontFamily: 'Jua')),
                            ),
                          ],
                        ),
                      ),

...
class _LevelEightScreenState extends State<LevelEightScreen> with TickerProviderStateMixin {
          ...
          children: [
            ...
            Scaffold(
              ...
              appBar: AppBar(
                title: Row(
                  children: [
                    const Text("Level 8", style: TextStyle(fontFamily: 'Jua', color: Colors.black)),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                await _updateProgress(8);
                                Navigator.pushReplacementNamed(context, '/level9');
                              },

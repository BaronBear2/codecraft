...
class LevelTenScreen extends StatefulWidget {
  const LevelTenScreen({super.key});

  @override
  State<LevelTenScreen> createState() => _LevelTenScreenState();
}

class _LevelTenScreenState extends State<LevelTenScreen> with TickerProviderStateMixin {
          ...
          children: [
            ...
            Scaffold(
              ...
              appBar: AppBar(
                title: Row(
                  children: [
                    const Text("Level 10", style: TextStyle(fontFamily: 'Jua', color: Colors.black)),

...
class LevelNineScreen extends StatefulWidget {
  const LevelNineScreen({super.key});

  @override
  State<LevelNineScreen> createState() => _LevelNineScreenState();
}

class _LevelNineScreenState extends State<LevelNineScreen> with TickerProviderStateMixin {
          ...
          children: [
            ...
            Scaffold(
              ...
              appBar: AppBar(
                title: Row(
                  children: [
                    const Text("Level 9", style: TextStyle(fontFamily: 'Jua', color: Colors.black)),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                await _updateProgress(9);
                                Navigator.pushReplacementNamed(context, '/level10');
                              },
